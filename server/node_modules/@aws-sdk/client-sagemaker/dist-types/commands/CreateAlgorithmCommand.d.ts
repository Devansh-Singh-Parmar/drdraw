...
declare const CreateAlgorithmCommand_base: {
    new (input: CreateAlgorithmCommandInput): import("@smithy/core/client").CommandImpl<CreateAlgorithmCommandInput, CreateAlgorithmCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateAlgorithmCommandInput): import("@smithy/core/client").CommandImpl<CreateAlgorithmCommandInput, CreateAlgorithmCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
